...
class GuiPart:
    ...
    def __init__(self, master, queue, endCommand):
        ...
        #copying and pasting code from processIncoming so that msg can be used by the button
        ...
        button2 = tkinter.Button(root, text='print thread msg', command = lambda: self.com(msg))
        button2.pack(  )
