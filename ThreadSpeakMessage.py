...
class GuiPart:
    def com(self, c):
        #c = "message message 1 2 3"
        #speak function doesn't work
        #self.speak(c,"test")
        #myobj = gTTS(text=c, lang='en', slow=False)
        #myobj.save("test" + ".mp3")
        #os.system("start " + "test" + ".mp3")
        labl2 = Label(text=c, font=20).pack()

    #Speak function from Nik's code- we may want to change the speak function
    def speak(self, x, y):
    ...
    def __init__(self, master, queue, endCommand):
        ...
        console.pack(  )
        button1 = tkinter.Button(text='Press to print', command=self.com("message 1"))
        button1.pack(  )
